    ...
    return (
        <div className="MenuSection">
            ...
            <div className='ButtonSection'>
                <Button text="Dessert" onClick={() => handleFilterClick('Dessert')} isActive={selectedCategory === 'Dessert'} />
                <Button text="Dinner" onClick={() => handleFilterClick('Dinner')} isActive={selectedCategory === 'Dinner'} />
                <Button text="Breakfast" onClick={() => handleFilterClick('Breakfast')} isActive={selectedCategory === 'Breakfast'} />
            </div>
